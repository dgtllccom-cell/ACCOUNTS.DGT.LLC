...
cd /d "%~dp0"
echo =======================================================================
echo   UNIFIED 1-CLICK CODE SYNC & DEPLOYMENT (dgtllccom-cell/ACCOUNTS.DGT.LLC)
echo =======================================================================
echo.

echo [1/5] Setting Git remote to target repository ACCOUNTS.DGT.LLC...
...
echo.
echo [4/5] Pushing unified code to GitHub (https://github.com/dgtllccom-cell/ACCOUNTS.DGT.LLC.git)...
