...
import { FinancialStatementsReportView } from "@/features/reports/components/financial-statements-report-view";
import type { ReportMetaOption } from "@/features/reports/components/universal-report-shell";

export const dynamic = "force-dynamic";
export const metadata: Metadata = { title: "Financial Statements — ERP" };

export default async function FinancialStatementsReportPage() {
  ...
  return <FinancialStatementsReportView context={context} countries={countries} />;
}
