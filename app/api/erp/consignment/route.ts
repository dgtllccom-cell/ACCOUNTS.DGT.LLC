...
const createSchema = z.object({
  ...
  tenderNo: z.string().trim().max(120).optional().nullable(),
  loadingFromDate: z.string().trim().max(40).optional().nullable(),
  loadingToDate: z.string().trim().max(40).optional().nullable(),
  referenceValue: z.union([z.number(), z.string().trim()]).optional().nullable(),
