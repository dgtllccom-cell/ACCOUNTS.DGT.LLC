...
const patchSchema = z.object({
  ...
  tenderNo: z.string().trim().max(120).nullable().optional(),
  loadingFromDate: z.string().trim().max(40).nullable().optional(),
  loadingToDate: z.string().trim().max(40).nullable().optional(),
  referenceValue: z.union([z.number(), z.string().trim()]).nullable().optional(),
