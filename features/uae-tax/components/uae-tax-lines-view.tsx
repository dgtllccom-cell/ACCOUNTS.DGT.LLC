...
export function UaeTaxLinesView({
  ...
  const printConfig = () => ({
    ...
    columns: [
      { key: "source_date", label: s.t("ln_col_date", "Date"), format: "date" as const },
      { key: "source_reference_no", label: s.t("ln_col_bill", "Bill Number") },
      { key: "party_name", label: s.t("ln_col_party", "Party / Account") },
      { key: "description", label: s.t("ln_col_description", "Description") },
