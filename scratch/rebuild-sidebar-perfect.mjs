...
// Let's restore pristine first
import { execSync } from 'child_process';
execSync('git checkout HEAD -- components/layout/digital-dock-premium-sidebar.tsx', { cwd: 'b:/accounts.dgt.llc.code_project/ACCOUNTS.DGT.LLC' });
...
console.log("Successfully rebuilt digital-dock-premium-sidebar.tsx!");
