...
import { HrReportView } from "@/features/reports/components/hr-report-view";
import type { ReportMetaOption } from "@/features/reports/components/universal-report-shell";

export const dynamic = "force-dynamic";
export const metadata: Metadata = { title: "HR & Employee Reports — ERP" };
...
export default async function HrReportPage() {
  ...
  return <HrReportView context={context} countries={countries} />;
}
