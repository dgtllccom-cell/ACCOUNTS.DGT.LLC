...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    for (const ord of transferredOrders) {
      ...
      // Insert roznamcha_entries respecting roznamcha_scope_chk constraint:
      // (type = 'super_admin' AND country_id IS NULL) OR (type = 'country' AND country_id IS NOT NULL) OR (type = 'branch' AND (country_branch_id IS NOT NULL OR city_branch_id IS NOT NULL))
