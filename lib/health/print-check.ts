...
export function runPrintPdfCheck(): HealthFinding[] {
      ...
      try {
        ...
        if (!ok) {
          ...
          out.push({
            ...
            i18n: { titleKey: "health.f_print_nohtml", expectedKey: "health.fx_print_nohtml", params: { lang, case: c.name } },
        ...
        out.push({
          ...
          i18n: { titleKey: "health.f_print_threw", expectedKey: "health.fx_print_threw", params: { lang, case: c.name } },
  ...
  if (failures === 0) {
    out.push({
      ...
      i18n: { titleKey: "health.f_print_ok", expectedKey: "health.fx_print_ok" },
