...
import { RoznamchaReportView } from "@/features/reports/components/roznamcha-report-view";
import type { ReportMetaOption } from "@/features/reports/components/universal-report-shell";

export const dynamic = "force-dynamic";
export const metadata: Metadata = { title: "Roznamcha / Cash Report — ERP" };

export default async function RoznamchaReportPage() {
  ...
  return <RoznamchaReportView context={context} countries={countries} />;
}
