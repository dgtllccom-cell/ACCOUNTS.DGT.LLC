...
fs.writeFileSync("scripts/vps_inspect_loc_schema.mjs", script);
execSync(`scp -o StrictHostKeyChecking=no scripts/vps_inspect_loc_schema.mjs ${SERVER}:/var/www/dgt-nextjs/vps_inspect_loc_schema.mjs`);
execSync(`ssh -o StrictHostKeyChecking=no ${SERVER} "cd /var/www/dgt-nextjs && node vps_inspect_loc_schema.mjs && rm -f vps_inspect_loc_schema.mjs"`, { stdio: "inherit" });
