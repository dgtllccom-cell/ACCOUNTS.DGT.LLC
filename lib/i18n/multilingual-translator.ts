...
export const MULTILINGUAL_DICTIONARY: Array<{ en: string; ur: string; ar: string; fa: string; ps: string }> = [
  ...
  // ── ERP auto-narration field labels (roznamcha / ledger / payment descriptions) ──
  { en: "ADVANCE payment for", ur: "کے لیے پیشگی ادائیگی", ar: "دفعة مقدمة لأجل", fa: "پیش‌پرداخت برای", ps: "لپاره وړاندې تادیه" },
  { en: "REMAINING payment for", ur: "کے لیے بقایا ادائیگی", ar: "دفعة متبقية لأجل", fa: "پرداخت باقی‌مانده برای", ps: "لپاره پاتې تادیه" },
  { en: "CREDIT payment for", ur: "کے لیے کریڈٹ ادائیگی", ar: "دفعة آجلة لأجل", fa: "پرداخت اعتباری برای", ps: "لپاره پور تادیه" },
  { en: "remaining payment", ur: "بقایا ادائیگی", ar: "الدفعة المتبقية", fa: "پرداخت باقی‌مانده", ps: "پاتې تادیه" },
  { en: "credit payment", ur: "کریڈٹ ادائیگی", ar: "دفعة آجلة", fa: "پرداخت اعتباری", ps: "پور تادیه" },
  { en: "Purchase Bill", ur: "پرچیز بل", ar: "فاتورة شراء", fa: "صورتحساب خرید", ps: "د پیرود بیل" },
  { en: "Sales Bill", ur: "سیلز بل", ar: "فاتورة بيع", fa: "صورتحساب فروش", ps: "د پلور بیل" },
  { en: "Purchase Price", ur: "پرچیز قیمت", ar: "سعر الشراء", fa: "قیمت خرید", ps: "د پیرود بیه" },
  { en: "Sales Price", ur: "سیلز قیمت", ar: "سعر البيع", fa: "قیمت فروش", ps: "د پلور بیه" },
  { en: "System Bill", ur: "سسٹم بل", ar: "فاتورة النظام", fa: "صورتحساب سیستم", ps: "د سیسټم بیل" },
  { en: "Manual Bill", ur: "دستی بل", ar: "فاتورة يدوية", fa: "صورتحساب دستی", ps: "لاسي بیل" },
  { en: "Payment Currency", ur: "ادائیگی کرنسی", ar: "عملة الدفع", fa: "ارز پرداخت", ps: "د تادیې اسعارو" },
  { en: "Exchange Rate", ur: "زر مبادلہ کی شرح", ar: "سعر الصرف", fa: "نرخ ارز", ps: "د تبادلې نرخ" },
  { en: "Paid Amount", ur: "ادا شدہ رقم", ar: "المبلغ المدفوع", fa: "مبلغ پرداخت‌شده", ps: "تادیه شوې اندازه" },
  { en: "Receipt Amount", ur: "وصولی رقم", ar: "مبلغ الإيصال", fa: "مبلغ رسید", ps: "د رسید اندازه" },
  { en: "Final Amount", ur: "حتمی رقم", ar: "المبلغ النهائي", fa: "مبلغ نهایی", ps: "وروستۍ اندازه" },
  { en: "Gross Weight", ur: "مجموعی وزن", ar: "الوزن الإجمالي", fa: "وزن ناخالص", ps: "ټول وزن" },
  { en: "Net Weight", ur: "خالص وزن", ar: "الوزن الصافي", fa: "وزن خالص", ps: "خالص وزن" },
  { en: "Audit Trail", ur: "آڈٹ ٹریل", ar: "سجل التدقيق", fa: "ردپای حسابرسی", ps: "د پلټنې لاره" },
  { en: "Local Currency Entry", ur: "مقامی کرنسی اندراج", ar: "قيد بالعملة المحلية", fa: "ثبت به ارز محلی", ps: "د محلي اسعارو ننوت" },
  { en: "Cash Details", ur: "نقد تفصیلات", ar: "تفاصيل النقد", fa: "جزئیات نقدی", ps: "د نغدو تفصیلات" },
  { en: "cash activity", ur: "نقد سرگرمی", ar: "نشاط نقدي", fa: "فعالیت نقدی", ps: "نغدي فعالیت" },
  { en: "Receiver/Sender", ur: "وصول کنندہ/بھیجنے والا", ar: "المستلم/المرسل", fa: "گیرنده/فرستنده", ps: "ترلاسه کوونکی/لیږونکی" },
  { en: "Receiver", ur: "وصول کنندہ", ar: "المستلم", fa: "گیرنده", ps: "ترلاسه کوونکی" },
  { en: "Sender", ur: "بھیجنے والا", ar: "المرسل", fa: "فرستنده", ps: "لیږونکی" },
  { en: "Mobile", ur: "موبائل", ar: "الجوال", fa: "موبایل", ps: "ګرځنده" },
  { en: "WhatsApp", ur: "واٹس ایپ", ar: "واتساب", fa: "واتساپ", ps: "واټساپ" },
  { en: "Goods", ur: "مال", ar: "البضائع", fa: "کالا", ps: "مالونه" },
  { en: "Quantity", ur: "مقدار", ar: "الكمية", fa: "مقدار", ps: "مقدار" },
  { en: "Notes", ur: "نوٹس", ar: "ملاحظات", fa: "یادداشت‌ها", ps: "یادښتونه" },
  { en: "Party", ur: "فریق", ar: "الطرف", fa: "طرف", ps: "اړخ" },
  { en: "Branch", ur: "برانچ", ar: "الفرع", fa: "شعبه", ps: "څانګه" },
  { en: "Country", ur: "ملک", ar: "الدولة", fa: "کشور", ps: "هیواد" },
  { en: "Cartons", ur: "کارٹن", ar: "كراتين", fa: "کارتن", ps: "کارتنونه" },
  { en: "City Branch", ur: "سٹی برانچ", ar: "فرع المدينة", fa: "شعبه شهر", ps: "د ښار څانګه" },
  { en: "cash paid to", ur: "کو نقد ادا کیا", ar: "نقد مدفوع إلى", fa: "نقد پرداخت‌شده به", ps: "ته نغدې ورکړل شوې" },
  { en: "cash received from", ur: "سے نقد موصول", ar: "نقد مستلم من", fa: "نقد دریافت‌شده از", ps: "له ... څخه نغدې ترلاسه" },
  { en: "expense for", ur: "کے لیے اخراجات", ar: "مصروف لأجل", fa: "هزینه برای", ps: "لپاره لګښت" },
  { en: "payment against bill", ur: "بل کے عوض ادائیگی", ar: "دفعة مقابل الفاتورة", fa: "پرداخت در برابر صورتحساب", ps: "د بیل په مقابل کې تادیه" },
  { en: "loading expense", ur: "لوڈنگ اخراجات", ar: "مصروف التحميل", fa: "هزینه بارگیری", ps: "د پورته کولو لګښت" },
  { en: "unloading expense", ur: "ان لوڈنگ اخراجات", ar: "مصروف التفريغ", fa: "هزینه تخلیه", ps: "د ښکته کولو لګښت" },
  { en: "route expense", ur: "روٹ اخراجات", ar: "مصروف المسار", fa: "هزینه مسیر", ps: "د لارې لګښت" },
  { en: "customs clearance", ur: "کسٹم کلیئرنس", ar: "التخليص الجمركي", fa: "ترخیص گمرکی", ps: "ګمرکي پاکول" },
  { en: "container", ur: "کنٹینر", ar: "حاوية", fa: "کانتینر", ps: "کانټینر" },
  { en: "truck", ur: "ٹرک", ar: "شاحنة", fa: "کامیون", ps: "لاری" },
  { en: "driver", ur: "ڈرائیور", ar: "السائق", fa: "راننده", ps: "چلوونکی" },
  { en: "warehouse", ur: "گودام", ar: "المستودع", fa: "انبار", ps: "ګدام" },
  { en: "goods received note", ur: "مال وصولی نوٹ", ar: "إشعار استلام البضائع", fa: "رسید دریافت کالا", ps: "د مالونو د ترلاسې یادښت" },
  { en: "delivery note", ur: "ڈیلیوری نوٹ", ar: "إشعار التسليم", fa: "برگه تحویل", ps: "د سپارلو یادښت" },
  { en: "profit", ur: "منافع", ar: "الربح", fa: "سود", ps: "ګټه" },
  { en: "loss", ur: "نقصان", ar: "الخسارة", fa: "زیان", ps: "زیان" }
];
