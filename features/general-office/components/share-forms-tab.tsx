...
const dict: Record<string, Record<string, string>> = {
  ...
  viewForm: { en: "View Form", ur: "فارم دیکھیں", ar: "عرض النموذج", fa: "مشاهده فرم", ps: "فورم کتل" },
  ...
  submissionDetails: { en: "Submitted Form Details", ur: "جمع شدہ فارم کی تفصیلات", ar: "تفاصيل النموذج المُقدّم", fa: "جزئیات فرم ارسال شده", ps: "د سپارل شوي فورم تفصیلات" },
  closeModal: { en: "Close", ur: "بند کریں", ar: "إغلاق", fa: "بستن", ps: "بندول" },
  personalInfo: { en: "Personal Information", ur: "ذاتی معلومات", ar: "المعلومات الشخصية", fa: "اطلاعات شخصی", ps: "شخصي معلومات" },
  addressInfo: { en: "Address Details", ur: "پتے کی تفصیلات", ar: "تفاصيل العنوان", fa: "جزئیات آدرس", ps: "د پتې تفصیلات" },
