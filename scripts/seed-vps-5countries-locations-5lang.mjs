...
console.log("Preparing 5-Country Location Hierarchy and 5-Language Translations for VPS Production...");
...
fs.writeFileSync("scripts/vps_seed_5countries_locations.mjs", script);

try {
  execSync(`scp -o StrictHostKeyChecking=no scripts/vps_seed_5countries_locations.mjs ${SERVER}:/var/www/dgt-nextjs/vps_seed_5countries_locations.mjs`, { stdio: "inherit" });
  execSync(`ssh -o StrictHostKeyChecking=no ${SERVER} "cd /var/www/dgt-nextjs && node vps_seed_5countries_locations.mjs && rm -f vps_seed_5countries_locations.mjs"`, { stdio: "inherit" });
} catch (e) {
