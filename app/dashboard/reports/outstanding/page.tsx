...
import { ReceivablesReportView } from "@/features/reports/components/receivables-report-view";
import type { ReportMetaOption } from "@/features/reports/components/universal-report-shell";

export const dynamic = "force-dynamic";
export const metadata: Metadata = { title: "Outstanding & Recovery Reports — ERP" };
...
export default async function OutstandingReportPage() {
  ...
  return <ReceivablesReportView context={context} countries={countries} />;
}
