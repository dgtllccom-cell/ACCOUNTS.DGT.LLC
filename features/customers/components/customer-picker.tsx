          ...
          <div className="p-4 space-y-4 text-xs text-slate-800 dark:text-slate-200">
            <div className="flex items-center justify-between bg-slate-900 text-white p-4 rounded-xl">
              <div>
                ...
                <p className="text-xs text-slate-300 font-medium">Company: {viewCustomer.company_name || "Independent Account"}</p>
              </div>
              <div className="text-right">
                ...
                <p className="text-[10px] text-slate-400 mt-1">Lang: <span className="font-bold text-white font-mono uppercase">{viewCustomer.original_language_code || "en"}</span></p>
              </div>
            </div>
