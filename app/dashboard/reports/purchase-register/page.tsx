...
import { PurchaseRegisterReportView } from "@/features/reports/components/purchase-register-report-view";
import type { ReportMetaOption } from "@/features/reports/components/universal-report-shell";

export const dynamic = "force-dynamic";
export const metadata: Metadata = { title: "Purchase Register — ERP" };

export default async function PurchaseRegisterReportPage() {
  ...
  return <PurchaseRegisterReportView context={context} countries={countries} />;
}
