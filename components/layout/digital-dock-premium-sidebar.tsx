...
export const DAMAN_SIDEBAR_ITEMS: SidebarMenuItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: nt("Inter-Country Shipping Claims"), href: "/dashboard/inter-country-transfers?category=shipping_line", icon: ArrowRightLeft },
      { label: nt("Clearing Agents"), href: "/dashboard/clearing-agent", icon: Truck },
      { label: nt("Clearing Truck Registration"), href: "/dashboard/clearing-agent/truck-registration", icon: Truck },
