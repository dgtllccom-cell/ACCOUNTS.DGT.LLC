...
import { BranchOrgReportView } from "@/features/reports/components/branch-org-report-view";
import type { ReportMetaOption } from "@/features/reports/components/universal-report-shell";

export const dynamic = "force-dynamic";
export const metadata: Metadata = { title: "Branch & Organisation Reports — ERP" };

export default async function BranchOrgReportPage() {
  ...
  return <BranchOrgReportView context={context} countries={countries} />;
}
