...
console.log("===============================================================");
console.log(`  OPTION 2: DEPLOY [${BRANCH.toUpperCase()}] BRANCH TO TESTING VPS SERVERS`);
...
try {
  ...
  console.log(`[1/2] Syncing local changes to GitHub (${BRANCH} branch)...`);
  execSync('git add -A', { stdio: 'inherit' });
  try {
    execSync(`git commit -m "feat(dev-deploy): deploy ${BRANCH} branch to test servers"`, { stdio: 'inherit' });
  } catch (e) {
    console.log("No new changes to commit.");
  }
  execSync(`git push -u origin ${BRANCH}`, { stdio: 'inherit' });
  console.log(`✅ GitHub updated on ${BRANCH} branch!\n`);
} catch (err) {
...
for (const server of SERVERS) {
  console.log(`\n---------------------------------------------------------------`);
  console.log(`🚀 Deploying [${BRANCH}] branch to Server: ${server}`);
  console.log(`---------------------------------------------------------------`);
  try {
    ...
    console.log(out);
    console.log(`✅ Successfully deployed ${BRANCH} to ${server}`);
  } catch (e) {
...
console.log("\n===============================================================");
console.log(`  DEV VPS DEPLOYMENT COMPLETED!`);
console.log("===============================================================");
