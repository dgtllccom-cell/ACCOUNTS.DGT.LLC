"use strict";exports.id=46758,exports.ids=[46758],exports.modules={46758:(a,b,c)=>{function d(a){return String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function e(a,b){let c=Number(a||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2});return b?`${c} ${b}`:c}function f(a,b){let c=Number(a||0).toLocaleString("en-US",{maximumFractionDigits:2});return b?`${c} ${b}`:c}function g(a){if(!a)return"-";let b=new Date(a);return Number.isNaN(b.getTime())?a:b.toLocaleDateString("en-GB",{day:"2-digit",month:"short",year:"numeric"})}function h(a){let{title:b,orientation:c,companyInfo:e={},filters:f=[],kpis:h=[],mainTableHtml:i,footerNotesHtml:j,legendHtml:k,lang:l="en",csvData:m=""}=a,n=["ur","ar","fa","ps"].includes(l),o=e.name||"DIGITAL DOCK ERP",p=e.tagline||"ERP Reporting System",q=e.address||"Configured organization address",r=e.phone||"Configured contact",s=e.email||"Configured email",t=e.website||"Configured website",u=e.printedBy||"ERP User",v=e.printedDate||new Date().toLocaleString("en-US",{dateStyle:"medium",timeStyle:"short"}),w=e.financialYear||"Current Financial Year",x=e.reportPeriod||g(new Date().toISOString()),y=e.logoUrl||"",z=`ERP|${o}|${b}|${v}|${x}`,A=`https://api.qrserver.com/v1/create-qr-code/?size=120x120&data=${encodeURIComponent(z)}`;return`<!doctype html>
<html lang="${l}" dir="${n?"rtl":"ltr"}">
<head>
  <meta charset="utf-8" />
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .sheet {
      width: ${"landscape"===c?"287mm":"200mm"};
      max-width: 100%;
      min-height: ${"landscape"===c?"200mm":"287mm"};
      height: auto;
      background: #ffffff;
    ...
    .filter-bar {
      display: grid;
      grid-template-columns: repeat(${Math.max(1,f.length)}, 1fr);
      gap: 6px;
      background: #f8fafc;
  ...
  <script>
    ...
    function downloadCsv() {
      const csvRaw = \`${m.replace(/`/g,"\\`").replace(/\${/g,"\\${")}\`;
      ...
      a.href = url;
      a.download = '${b.toLowerCase().replace(/[^a-z0-9]+/g,"-")}-report.csv';
      a.click();
      URL.revokeObjectURL(url);
    }

    function sendEmail() {
      const subject = encodeURIComponent('${d(b)} - ${d(o)}');
      const body = encodeURIComponent('Please find attached official A4 ERP report for ${d(b)} from ${d(o)}.\\nDate: ${d(v)}\\nPeriod: ${d(x)}');
      window.location.href = 'mailto:?subject=' + subject + '&body=' + body;
    }

    function sendWhatsApp() {
      const text = encodeURIComponent('📄 *${d(b)}*\\nCompany: ${d(o)}\\nDate: ${d(v)}\\nPeriod: ${d(x)}\\nURL: ${d(t)}');
    ...
    <div class="sheet-scalable-viewport" id="sheetViewport">
      <div class="sheet">
        ...
        <div class="letterhead">
          <div class="brand-col">
            ${y?`<img class="brand-logo" src="${d(y)}" alt="logo" style="object-fit:contain;background:#fff;" />`:`<div class="brand-logo">⚓</div>`}
            <div class="brand-details">
              <div class="brand-name">${d(o)}</div>
              <div class="brand-tagline">${d(p)}</div>
              <div class="brand-contact">
                📍 ${d(q)}<br />
                📞 Phone: ${d(r)} | ✉️ Email: ${d(s)} | 🌐 Website: ${d(t)}
              </div>
            </div>
          </div>

          <div class="title-col">
            <h1 class="report-title-text">${d(b)}</h1>
            <div style="margin-top:6px;"><img src="${A}" alt="QR verify" style="width:48px;height:48px;" /><div style="font-size:6px;color:#64748b;">Scan to verify</div></div>
          </div>

          <div class="meta-col">
            <div>Printed By: <b>${d(u)}</b></div>
            <div>Printed Date: <b>${d(v)}</b></div>
            <div>Financial Year: <b>${d(w)}</b></div>
            <div>Report Period: <b>${d(x)}</b></div>
          </div>
        </div>
        ...
        <div class="filter-bar">
          ${f.map(a=>`
            <div class="filter-pill">
              <div class="filter-pill-label">${d(a.label)}</div>
              <div class="filter-pill-value">${d(a.value)}</div>
            </div>
          `).join("")}
        </div>
        `:""}
        ...
        <div class="kpi-grid">
          ${h.map(a=>`
            <div class="kpi-card ${a.color||""}">
              <div class="kpi-label">${d(a.label)}</div>
              <div class="kpi-value">${d(a.value)}</div>
            </div>
          `).join("")}
        </div>
        `:""}
        ...
        <div class="sheet-footer">
          ...
          <div class="bottom-bar">
            ${d(o)} &mdash; Official ERP System Generated Document
          </div>
        </div>
...
</html>`}c.d(b,{Hr:()=>h,Yq:()=>g,ZD:()=>d,ZV:()=>f,up:()=>e})}};