...
export const ERP_GLOSSARY: GlossaryEntry[] = [
  ...
  { en: "Settlement & Reconciliation", ur: "تصفیہ و مطابقت", ar: "التسوية والمطابقة", fa: "تسویه و مغایرت‌گیری", ps: "تصفیه او سمون", domain: "accounting" },
  { en: "Control Center", ur: "کنٹرول سینٹر", ar: "مركز التحكم", fa: "مرکز کنترل", ps: "د کنټرول مرکز", domain: "general", variants: ["control centre"] },
  { en: "Daily Settlement", ur: "روزانہ تصفیہ", ar: "التسوية اليومية", fa: "تسویه روزانه", ps: "ورځنۍ تصفیه", domain: "accounting" },
  { en: "Bank Settlement", ur: "بینک تصفیہ", ar: "تسوية البنك", fa: "تسویه بانکی", ps: "بانکي تصفیه", domain: "accounting" },
  { en: "Party / Accounts", ur: "فریق / اکاؤنٹس", ar: "الطرف / الحسابات", fa: "طرف / حساب‌ها", ps: "اړخ / حسابونه", domain: "accounting" },
  { en: "Payments", ur: "ادائیگیاں", ar: "المدفوعات", fa: "پرداخت‌ها", ps: "تادیات", domain: "accounting", variants: ["payment"] },
  { en: "Multi-Currency", ur: "کثیر کرنسی", ar: "متعدد العملات", fa: "چند ارزی", ps: "څو اسعاره", domain: "accounting", variants: ["multi currency", "multicurrency"] },
  { en: "Audit Trail", ur: "آڈٹ ٹریل", ar: "سجل التدقيق", fa: "رد پای حسابرسی", ps: "د پلټنې لړۍ", domain: "accounting", variants: ["audit log", "audit history"] },
  { en: "Reports Hub", ur: "رپورٹس ہب", ar: "مركز التقارير", fa: "مرکز گزارش‌ها", ps: "د راپورونو مرکز", domain: "general" },
  { en: "Sub-Modules", ur: "ذیلی ماڈیولز", ar: "الوحدات الفرعية", fa: "زیرماژول‌ها", ps: "فرعي ماډلونه", domain: "general", variants: ["sub-module", "submodule", "sub modules"] },
  { en: "Total Credit", ur: "کل کریڈٹ", ar: "إجمالي الدائن", fa: "مجموع بستانکار", ps: "ټول کریډیټ", domain: "accounting", variants: ["total credit (cr)"] },
  { en: "Total Debit", ur: "کل ڈیبٹ", ar: "إجمالي المدين", fa: "مجموع بدهکار", ps: "ټول ډیبیټ", domain: "accounting", variants: ["total debit (dr)"] },
  { en: "Remaining", ur: "باقی", ar: "المتبقي", fa: "باقی‌مانده", ps: "پاتې", domain: "accounting", variants: ["remaining balance"] },
  { en: "Settled", ur: "طے شدہ", ar: "مُسوّى", fa: "تسویه‌شده", ps: "تصفیه‌شوی", domain: "accounting" },
  { en: "Partial", ur: "جزوی", ar: "جزئي", fa: "جزئی", ps: "جزوي", domain: "accounting", variants: ["partially settled"] },
  { en: "Unsettled", ur: "غیر طے شدہ", ar: "غير مُسوّى", fa: "تسویه‌نشده", ps: "ناتصفیه‌شوی", domain: "accounting", variants: ["unsettled list"] },
  { en: "Status Counts", ur: "اسٹیٹس گنتی", ar: "أعداد الحالة", fa: "شمارش وضعیت", ps: "د حالت شمېر", domain: "general" },
  { en: "Net FX Realized", ur: "خالص FX منافع/نقصان", ar: "صافي فروق الصرف المحققة", fa: "خالص تفاوت ارز محقق‌شده", ps: "خالص تحقق‌شوی FX", domain: "accounting", variants: ["net fx", "fx realized"] },
  { en: "FX Gain", ur: "زرمبادلہ منافع", ar: "ربح فروق الصرف", fa: "سود تسعیر ارز", ps: "د اسعارو ګټه", domain: "accounting", variants: ["gain", "fx gain / loss"] },
  { en: "FX Loss", ur: "زرمبادلہ نقصان", ar: "خسارة فروق الصرف", fa: "زیان تسعیر ارز", ps: "د اسعارو زیان", domain: "accounting", variants: ["loss"] },
  { en: "Sync", ur: "ہم آہنگ کریں", ar: "مزامنة", fa: "همگام‌سازی", ps: "همغږي کول", domain: "general", variants: ["synchronize", "sync now", "sync erp records", "syncing"] },
  { en: "Refresh", ur: "ریفریش کریں", ar: "تحديث", fa: "بازخوانی", ps: "تازه کول", domain: "general", variants: ["reload"] },
  { en: "Download", ur: "ڈاؤن لوڈ کریں", ar: "تنزيل", fa: "دانلود", ps: "ښکته کول", domain: "general" },
  { en: "Local Amount", ur: "مقامی رقم", ar: "المبلغ المحلي", fa: "مبلغ محلی", ps: "محلي مقدار", domain: "accounting" },
  { en: "USD Amount", ur: "ڈالر رقم", ar: "المبلغ بالدولار", fa: "مبلغ دلاری", ps: "د ډالرو مقدار", domain: "accounting" },
  { en: "Company", ur: "کمپنی", ar: "الشركة", fa: "شرکت", ps: "شرکت", domain: "general", variants: ["legal entity", "company profile"] },
  { en: "Branch", ur: "برانچ", ar: "الفرع", fa: "شعبه", ps: "څانګه", domain: "general", variants: ["branches"] },
  { en: "Letterhead", ur: "لیٹر ہیڈ", ar: "ترويسة", fa: "سربرگ", ps: "سرلیک", domain: "general" },
  { en: "Company Logo", ur: "کمپنی لوگو", ar: "شعار الشركة", fa: "لوگوی شرکت", ps: "د شرکت لوگو", domain: "general", variants: ["logo"] },
  { en: "Assigned Company", ur: "تفویض شدہ کمپنی", ar: "الشركة المُسنَدة", fa: "شرکت تخصیص‌یافته", ps: "ټاکل‌شوی شرکت", domain: "general" },
