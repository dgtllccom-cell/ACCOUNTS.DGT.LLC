...
import { SettlementReportView } from "@/features/reports/components/settlement-report-view";
import type { ReportMetaOption } from "@/features/reports/components/universal-report-shell";

export const dynamic = "force-dynamic";
export const metadata: Metadata = { title: "Settlement Reports — ERP" };
...
export default async function SettlementReportPage() {
  ...
  return <SettlementReportView context={context} countries={countries} />;
}
