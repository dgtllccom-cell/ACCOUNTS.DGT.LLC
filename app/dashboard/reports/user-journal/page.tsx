...
import { UserJournalReportView } from "@/features/reports/components/user-journal-report-view";
import type { ReportMetaOption } from "@/features/reports/components/universal-report-shell";

export const dynamic = "force-dynamic";
export const metadata: Metadata = { title: "User Journal & Access Reports — ERP" };

export default async function UserJournalReportPage() {
  ...
  return <UserJournalReportView context={context} countries={countries} />;
}
