...
export function openCompany360Report(data: Company360ReportData) {
  ...
  const compNameEn = comp.name || "Company Account";
  const compNameUrdu = comp.nameUrdu || transliterateProperNoun(compNameEn, "ur");
  const ownerName = owner?.name || "Company Owner";
    ...
    <div class="container">
      ...
      <div class="top-header">
        <div class="brand-logo">
          ...
          <div>
            <div class="brand-title">DAMAAN GROUP • GLOBAL ERP</div>
        ...
        <div class="report-badge">
          ...
          <div><strong>Account No:</strong> <span style="font-family:monospace; font-weight:900; color:#1e3a8a;">${escapeHtml(comp.accountNo || "1001001")}</span></div>
        </div>
      </div>
      ...
      <div class="footer-sigs">
        ...
        <div class="seal-box">
          <div style="font-size:10px; font-weight:900; color:#1e3a8a; margin-bottom:2px;">DAMAAN GROUP ERP</div>
          <div>★ OFFICIAL CORPORATE SEAL ★</div>
          <div style="font-family:monospace; font-size:7px; margin-top:2px;">VERIFIED ID: ${escapeHtml(comp.id ? comp.id.slice(0, 16) : "ERP-VERIFIED-SECURE")}</div>
        </div>
      ...
      <div class="audit-footer">
        <div>Generated by DAMAAN Global ERP Corporate Registry System • ISO-27001 Compliant</div>
        <div>Report Ref: DOSSIER-${escapeHtml(comp.accountNo || "1001001")}-${escapeHtml(comp.companyCode || "CMP")} • Page 1 of 1</div>
      </div>
