  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-center items-center p-6 relative overflow-hidden font-sans">
      ...
      <div className="mb-6 text-center z-10">
        ...
        <h2 className="text-2xl font-black text-white mt-3 tracking-tight">Sign in to your DGT Mail</h2>
        <p className="text-xs text-slate-400 mt-1">
          Access your inbox, sent messages, and online verification codes
        </p>
      </div>
