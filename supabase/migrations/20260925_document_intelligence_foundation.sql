...
INSERT INTO public.document_type_registry (code, name, operational_domain, category, target_module, classifier_keywords, requires_qvc, rank_order) VALUES
  ...
  ('commercial_invoice',     'Commercial / Supplier Invoice','business','purchase','purchase_orders', ARRAY['commercial invoice','supplier invoice','tax invoice','invoice no'], true, 50),
  ...
  ('sales_invoice',          'Sales Proforma / Commercial Invoice','business','sales','sales_orders', ARRAY['invoice','proforma invoice','commercial invoice'], true, 240),
