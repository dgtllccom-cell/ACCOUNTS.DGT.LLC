...
import { ShippingClearingReportView } from "@/features/reports/components/shipping-clearing-report-view";
import type { ReportMetaOption } from "@/features/reports/components/universal-report-shell";

export const dynamic = "force-dynamic";
export const metadata: Metadata = { title: "Shipping & Clearing Reports — ERP" };

export default async function ShippingClearingReportPage() {
  ...
  return <ShippingClearingReportView context={context} countries={countries} />;
}
