...
import { AccountMasterReportView } from "@/features/reports/components/account-master-report-view";
import type { ReportMetaOption } from "@/features/reports/components/universal-report-shell";

export const dynamic = "force-dynamic";
export const metadata: Metadata = { title: "Account Master Reports — ERP" };

export default async function AccountMasterReportPage() {
  ...
  return <AccountMasterReportView context={context} countries={countries} />;
}
