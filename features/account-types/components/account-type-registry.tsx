...
export function AccountTypeRegistry() {
  ...
  return (
    ...
    <UniversalReportModal
      ...
      subtitle="Master Account Type & Ledger Group Classification"
      exportFileName="account_types_report"
      filters={[
      ...
      columns={[
        { key: "code", label: "Code" },
        { key: "name", label: "Account Type Name" },
