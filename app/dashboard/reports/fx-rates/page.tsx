...
import { ExchangeRateReportView } from "@/features/reports/components/exchange-rate-report-view";
import type { ReportMetaOption } from "@/features/reports/components/universal-report-shell";

export const dynamic = "force-dynamic";
export const metadata: Metadata = { title: "Exchange Rate Reports — ERP" };
...
export default async function ExchangeRateReportPage() {
  ...
  return <ExchangeRateReportView context={context} countries={countries} />;
}
