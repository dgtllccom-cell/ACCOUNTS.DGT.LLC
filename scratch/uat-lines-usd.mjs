...
await withLocalPg(async (sql) => {
  ...
  // roznamcha entry FX fields
  const e = (await sql`SELECT original_currency_code, currency_name, base_currency_amount, exchange_rate, usd_amount, usd_rate FROM public.roznamcha_entries WHERE id='91ee0b38-8480-4008-9751-62bbd37ba10e'`)[0];
