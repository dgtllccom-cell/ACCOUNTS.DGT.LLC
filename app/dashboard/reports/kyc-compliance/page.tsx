...
import { KycReportView } from "@/features/reports/components/kyc-report-view";
import type { ReportMetaOption } from "@/features/reports/components/universal-report-shell";

export const dynamic = "force-dynamic";
export const metadata: Metadata = { title: "KYC & Compliance Reports — ERP" };

export default async function KycComplianceReportPage() {
  ...
  return <KycReportView context={context} countries={countries} />;
}
