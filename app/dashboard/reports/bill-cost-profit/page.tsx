...
import { BillCostProfitReportView } from "@/features/reports/components/bill-cost-profit-report-view";
import type { ReportMetaOption } from "@/features/reports/components/universal-report-shell";

export const dynamic = "force-dynamic";
export const metadata: Metadata = { title: "Bill Cost, Expenses & Profit — ERP" };

export default async function BillCostProfitReportPage() {
  ...
  return <BillCostProfitReportView context={context} countries={countries} />;
}
